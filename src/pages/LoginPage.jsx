...
import { loginUser, signInWithGoogle, resetPassword, signInWithDemo } from "../firebase";
import {
            ...
            <>
              ...
              <div className="mt-4">
                <button
                  ...
                  className="w-full bg-[#A9927D] text-white font-medium py-3 rounded-lg hover:bg-[#8D7B68] transition-colors flex items-center justify-center gap-2 disabled:bg-gray-400"
                >
                  <svg 
                    className="w-5 h-5" 
                    fill="none" 
                  ...
                  {demoLoading ? "Loading Demo..." : "Quick Access Demo"}
                </button>
                <p className="text-xs text-gray-500 text-center mt-2">
                  Perfect for recruiters and quick evaluation
                </p>
              </div>
